...
\begin{definition}[Model]
  \label{def:model}
  Ať $L$ je \hyperref[def:jazyk]{jazyk} a $T$ \hyperref[def:teorie]{teorie} v
  jazyce $L$. \emph{Modelem} teorie $T$ je struktura, v níž jsou všechny věty
  (či formálněji všechny gramaticky správné posloupnosti symbolů) teorie $T$
  pravdivé.
\end{definition}
...
\begin{parable}
  ...
  \emph{lživé}) věty zahrneme do teorie $T$ jazyka českého, pak jejím modelem
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[xshift=10cm]
      ...
      height=2cm,ultra thick] (em) at (0,0) {};
      \node at (90:1.4) {\clg{\textsf{Model}}};

      % Picture
      \clip (0,0) ellipse (2cm and 1cm);
      \node at (0,0) { \includegraphics[width=4cm]{figs/deer-grazing.jpg}};
    \end{scope}
  \end{tikzpicture}
