...
\section*{Programování -- úloha 6}

Spočtěte \tr{výstup} nervové sítě se \tb{vstupy} a \tg{váhami} spojů
vyobrazenými níže za předpokladu, že aktivační funkcí neuronů je vážený průměr.
Bude se vám k tomu hodit kalkulačka.
