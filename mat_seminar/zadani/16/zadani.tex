...
\section*{Programování -- úloha 2}

Nakreslete flowchart následujícího algoritmu napsaného v Pythonu (je též ve
zvláštním souboru).

\begin{center}
 \begin{python}
  seznam = [1, 2, 3, 4, 5]  # nemusite do flowchartu vypisovat
  novy_seznam = []
  for prvek in seznam:
      if prvek % 2 == 0:
