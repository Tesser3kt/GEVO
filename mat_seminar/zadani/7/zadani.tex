...
\section*{Hardware -- úloha 7}

Nakreslete diagram vnitřku LCD monitoru (vyberte si LED nebo OLED). Řádně
vysvětlete, jak jednotlivé části fungují a jak spolu interagují.
