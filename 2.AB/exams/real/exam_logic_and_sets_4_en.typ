...
#block(width: 100%)[
  ...
  #points(10)
  Consider a new logical operator $dot.o$ given by the following truth table:
  #align(center)[
    #table(
  ...
  Write the proposition $p dot.o q$ using only the standard logical operators
  $not$, $and$, $or$, $=>$ and $<=>$.
]
#pagebreak()
...
#block(width: 100%)[
  #points(35)
  Given sets $A = {1, 2, 3, 4, 5}$, $B = {2, 4, 5}$ and $C = {1, 4, 5}$,
  determine the sets
  #math.equation(numbering: none, block: true)[
    $A without (B union C) " and " (A union B) inter C$
  ]
]
...
#block(width: 100%)[
  === #text(airblue)[Bonus Problem]
  #points(10)
  Consider the logical operator $dot.o$ from the previous bonus problem.
  Determine the set ${x | x in A dot.o x in B}$ where $A$ and $B$ are defined
  above. Give some *comments* on the method you used to obtain the set.
]
...
#block(width: 100%)[
  ...
  Draw a Venn diagram of the *complement* of the set $(A inter B) union C$
