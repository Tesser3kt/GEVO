...
\begin{lemproof}
 ...
 Ukážeme, že $\lim x = S$. Předpokládejme pro spor, že existuje $\varepsilon>0$
 takové, že pro každé $n_0 \in \N$ existuje $n \in \N$ takové, že $|x_n - S|
 \geq \varepsilon$ (tento výrok je přesnou negací
 \hyperref[def:limita-posloupnosti]{definice limity}).

 Vezměme tedy nějaké takové $\varepsilon>0$ a volme $n_0 \coloneqq 1$. Pak
 $|x_n-S| \geq \varepsilon$ pro nějaké $n \in \N$. Ovšem 
\end{lemproof}
