...
\begin{figure}[ht]
 ...
 \begin{subfigure}[b]{.99\textwidth}
  ...
  \begin{tikzpicture}
   ...
   \tkzLabelPoint[below,RoyalBlue,yshift=-1mm](l){$a_1$}
   \tkzLabelPoint[below,RoyalBlue,yshift=-1mm](r){$b_1$}
   \foreach \x in {1,2,...,10} {
    \tkzDefPoint(3.5 + \x / 10,0){a\x}
    \tkzDefPoint(4 + \x / 20,0){b\x}
    \tkzDrawPoints[size=4](a\x,b\x)
 ...
 \begin{subfigure}[b]{.99\textwidth}
  ...
  \begin{tikzpicture}
   ...
   \tkzDrawSegment[thick,ForestGreen](l,r)
   \tkzLabelPoint[below,ForestGreen,yshift=-1mm](l){$a_2$}
   \tkzLabelPoint[below,ForestGreen,yshift=-1mm](r){$b_2$}
   \foreach \x in {1,2,...,10} {
    \tkzDefPoint(3.5 + \x / 10,0){a\x}
    \tkzDefPoint(4 + \x / 20,0){b\x}
    \tkzDrawPoints[size=4](a\x,b\x)
   ...
   \tkzDefPoint(8.5,0){n}
   \tkzDrawPoints[size=4](a,b,c,d,e,f,g,h,i,j,k,m,n)
   \node[ForestGreen] at (l) {$[$};
   \node[ForestGreen] at (r) {$]$};
