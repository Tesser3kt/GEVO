...
\input{real-functions/elementary-functions/exponential}
\input{real-functions/elementary-functions/goniometric}
\input{real-functions/elementary-functions/elementary-limits}
