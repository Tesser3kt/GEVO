...
% TODO
\clr{\textbf{Tato kapitola se nachází v pracovní verzi. Neočekávajte obrázky,
...
\input{derivatives/calculating-derivatives}
\input{derivatives/mean-value-theorems}
\input{derivatives/lhospital}
