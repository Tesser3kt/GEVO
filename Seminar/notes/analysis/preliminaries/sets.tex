...
\input{preliminaries/sets/operations}
\input{preliminaries/sets/tuples}
\input{preliminaries/sets/relations}
\input{preliminaries/sets/equivalence}
\input{preliminaries/sets/orderings}
\input{preliminaries/sets/maps}
