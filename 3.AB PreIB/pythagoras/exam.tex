 ...
 \item You're given the following triangle:
  \begin{center}
   \begin{tikzpicture}
    ...
    \tkzDrawSegment[thick,dashed,color=RoyalBlue](a,c)
    \tkzDrawSegment[thick,color=ForestGreen](a,b)
    \tkzDrawSegment[thick,color=Magenta](c,sab)
   ...
   \end{tikzpicture}
  \end{center}
  Calculate the length of $\clb{b}$ if you know that $\clr{a} = \sqrt{45},
  \clg{c} = 8$ and $\clm{v_c} = 3$.
 \item Calculate the distance between $(2, 0, -1)$ and $(3, -3, 1)$ by altering
