...
\begin{figure}[ht]
 ...
 \begin{subfigure}[b]{.48\textwidth}
  ...
  \begin{tikzpicture}[scale=1.5]
   ...
   \tkzDrawArc[R,->,thick,color=BrickRed](o,0.2)(70,380)
   \tkzDrawLine[->,thick,color=BrickRed,add=-.1 and -.1](d,a)
   \tkzDrawLine[->,thick,color=BrickRed,add=-.1 and -.1](c,b)
   \tkzDrawLine[->,thick,color=BrickRed,add=-.1 and -.1](b,a)
  \end{tikzpicture}
